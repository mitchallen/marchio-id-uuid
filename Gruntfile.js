module.exports = function (grunt) {
    ...
    grunt.initConfig({
            ...
            dist: {
                options: {
                    browserifyOptions: {
                        ...
                        standalone: 'MitchAllen.-marchio-id-uuid'
                        // standalone: 'mitchallen.-marchio-id-uuid'
                    },
                ...
                files: {
                   ...
                   "./dist/marchio-id-uuid.js": ["./modules/index.js"]
                   // For non-standalone, use ./browser.js instead.
                   // "./dist/marchio-id-uuid.js": ["./browser.js"]
                }
            }
        },
        ...
        uglify: {
            my_target: {
                files: {
                    './dist/marchio-id-uuid.min.js': ['./dist/marchio-id-uuid.js']
                }
            }
        },
